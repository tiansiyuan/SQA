...
gv_vAlignTable['u16'] = 'top';gv_vAlignTable['u15'] = 'center';document.getElementById('u10_img').tabIndex = 0;
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('文章详细.html');
