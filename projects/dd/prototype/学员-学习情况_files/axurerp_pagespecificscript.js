...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('学员-记录详细页面.html');
...
gv_vAlignTable['u41'] = 'top';gv_vAlignTable['u43'] = 'center';gv_vAlignTable['u10'] = 'center';document.getElementById('u11_img').tabIndex = 0;
