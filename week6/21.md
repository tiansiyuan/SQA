...
-	PCA: how?
	...
	-	Solve j(cid:6) (cid:0) (cid:3)j = 0 to obtain eigenvalues (cid:21)j along the diagonal for the diagonal matrix (cid:3)
...
-	Obtaining PCA results: (cid:3); C; T can be calculated by statistical packages/tools.
